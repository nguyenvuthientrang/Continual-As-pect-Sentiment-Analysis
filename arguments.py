...
def asc_config(parser):
    ...
    parser.add_argument('--baseline',default='',type=str,required=True,
                        ...
                        choices=['ncl','one','mtl','l2','a-gem','derpp','kan','srk','ewc','hal','ucl','owm','acl','hat','cat','b-cl','classic', 'classic_vd', 'ctr'])

    parser.add_argument('--task',default='',type=str,required=True,help='what datasets',
                        choices=['asc_vd', 'asc','dsc','ssc','nli','newsgroup','celeba','femnist','vlcs','cifar10','mnist','fashionmnist','cifar100'])
    ...
    parser.add_argument('--KL_weight', type=float, default=0, help='Choose the KL weight of noise')
